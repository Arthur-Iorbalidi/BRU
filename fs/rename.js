...
const renameFile = (oldFilename, newFilename) => {
    const oldPath = path.join(__dirname, 'movies', oldFilename);
    const newPath = path.join(__dirname, 'movies', newFilename);
...
if (oldFilename && newFilename) {
    ...
    console.log('Использование: node rename.js <старое_название> <новое_название>');
}
